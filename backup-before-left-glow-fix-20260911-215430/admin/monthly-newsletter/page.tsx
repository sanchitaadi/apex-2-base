...
const EMPTY_FORM: FormState = {
  ...
  document_url: "",
  external_url: "",
  document_label: "Read newsletter",
  sort_order: 0,
  is_active: true,
};

export default function AdminMonthlyNewsletterPage() {
  ...
  function openEdit(item: NewsletterDocument) {
    ...
    setForm({
      ...
      document_label:
        item.document_label || "Read newsletter",
  ...
  async function uploadPdf(file: File) {
    ...
    if (file.size > maxSize) {
      throw new Error(
        `This PDF is ${(file.size / 1024 / 1024).toFixed(
          1
        )} MB. Your current Supabase project allows files up to 50 MB. Please compress the PDF before uploading it.`
      );
    }
  ...
  async function saveDocument(
    ...
    if (
      ...
      alert(
        "Please upload the actual newsletter PDF."
      );
      return;
    }
    ...
    try {
      ...
      const payload = {
        ...
        /*
         * IMPORTANT:
         * Everything is stored under one category.
         */
        category: CATEGORY,
        ...
        <div className="mb-8 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600">
              Manage every school newsletter and booklet.
              Uploaded PDFs are used by both the Monthly
              Newsletter and Apexian Accolade pages.
            </p>
        ...
        <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
          ...
          <div className="border-b border-slate-200 px-5 py-4">
            ...
            <p className="mt-1 text-sm text-slate-500">
              One record powers the public newsletter archive
              and the Apexian Accolade collection.
            </p>
          ...
          {loading ? (
            ...
            <div className="flex min-h-[320px] flex-col items-center justify-center px-6 text-center">
              ...
              <p className="mt-2 text-sm text-slate-500">
                Add your first newsletter or booklet.
              </p>
          ...
          <div className="mx-auto my-6 w-full max-w-2xl overflow-hidden rounded-2xl bg-white shadow-2xl">
            ...
            <div className="flex items-center justify-between border-b border-slate-200 px-5 py-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Upload the actual PDF to your Supabase Storage.
                </p>
              ...
              <div className="space-y-5 p-5 sm:p-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Official Apex Public School publication."
                    className="w-full rounded-xl border border-slate-300 px-4 py-3 text-sm outline-none focus:border-[#102a56]"
                  />
                ...
                <div>
                  ...
                  <label className="flex cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-300 bg-slate-50 px-5 py-8 text-center hover:bg-slate-100">
                    ...
                    <span className="mt-1 text-xs text-slate-500">
                      Maximum 50 MB on the current Supabase project
                    </span>
                        ...
                        if (
                          ...
                          alert(
                            `This PDF is ${(
                              ...
                              1
                            )} MB. Please compress it to under 50 MB.`
                          );
                  ...
                  {form.document_url &&
                    !selectedFile && (
                      <div className="mt-3 rounded-xl bg-emerald-50 p-3 text-sm text-emerald-700">
                        PDF uploaded successfully. Upload
                        another PDF to replace it.
                      </div>
                    )}
                ...
                <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs leading-5 text-slate-500">
                      Published records appear automatically
