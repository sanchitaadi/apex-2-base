...
export default function FeeStructurePage() {
  ...
  async function loadFeeDocuments() {
    setLoading(true);
  ...
  function getDocumentUrl(document: FeeDocument) {
    return (
  ...
  /*
   * If an older/newer document does not contain a year in its title,
   * keep it visible under "Other Fee Documents" instead of losing it.
   */
  ...
  }, [documents, currentDocuments, previousDocuments]);
    ...
    <main className="min-h-screen bg-[#f4f1ea] text-[#102a56]">
      ...
      <section className="relative overflow-hidden bg-[#102a56]">
        ...
        <div className="pointer-events-none absolute inset-0">
          ...
          <div className="absolute bottom-[-180px] left-[-120px] h-[360px] w-[360px] rounded-full border border-white/5" />
        </div>
        ...
        <div className="relative mx-auto max-w-7xl px-5 py-20 sm:px-8 sm:py-24 lg:px-10 lg:py-28">
          ...
          <div className="max-w-4xl">
            ...
            <p className="mt-7 max-w-2xl text-base leading-8 text-white/70 sm:text-lg">
              View the official fee structure documents published
              by Apex Public School for the current and previous
              academic sessions.
            </p>
      ...
      {/* =========================================================
          INTRO
      ========================================================= */}
      <section className="mx-auto max-w-7xl px-5 pt-10 sm:px-8 sm:pt-14 lg:px-10">

        <div className="max-w-3xl">
          <div className="mb-3 text-xs font-bold uppercase tracking-[0.2em] text-[#102a56]/60">
            Official Documents
          </div>

          <h2 className="text-2xl font-semibold tracking-tight text-[#102a56] sm:text-3xl">
            Fee information
          </h2>

          <p className="mt-3 text-sm leading-7 text-slate-600 sm:text-base">
            The documents below are published for reference.
            Select the current session document to view the
            complete fee structure directly on this page.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="mx-auto max-w-3xl rounded-[30px] border border-[#d8d4cc] bg-white px-8 py-16 text-center shadow-[0_20px_60px_rgba(16,42,86,0.06)]">
            ...
            <p className="mx-auto mt-3 max-w-lg text-sm leading-7 text-slate-500">
              The fee structure documents are currently
              unavailable.
            </p>
          ...
          <div className="space-y-20">
              ...
              <section>
                ...
                <div className="mb-8">
                  ...
                  <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-600 sm:text-base">
                    Official fee structure documents for the
            ...
            {previousDocuments.length > 0 && (
              <section>
                ...
                <div className="mb-8">
                  ...
                  <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-600 sm:text-base">
                    Previous official fee documents are retained
                    here for reference.
                  </p>
            ...
            {/* =====================================================
                FALLBACK
                If documents exist but don't have recognizable
                year strings, display them here.
            ===================================================== */}
            {currentDocuments.length === 0 &&
              previousDocuments.length === 0 &&
              otherDocuments.length === 0 && (
                <div className="rounded-[28px] border border-[#d8d4cc] bg-white p-10 text-center">
                  <FileText className="mx-auto h-9 w-9 text-[#102a56]" />
          ...
          <div className="mx-auto max-w-7xl px-5 py-8 sm:px-8 lg:px-10">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-start">
              ...
              <p className="max-w-3xl text-xs leading-6 text-slate-500">
                Please refer to the official document for the
                complete fee details, applicable charges and
      ...
      {url ? (
        ...
        <div className="border-y border-slate-200 bg-slate-50 px-6 py-20 text-center">
          ...
          <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-500">
            No valid document URL has been configured for this
            fee structure.
          </p>
